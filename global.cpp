...
void Global::creatWidgList() {
    ...
    addWidgList(WidgetType::Dispax,"Dispax", 0, 1, 400, 330, 120, set_dino_speed, set_dino_On_Off);
    ...
    addWidgList(WidgetType::Pump,"Sūknis 2",1, 1, 433, 483, 50, On_Pump_2_FW, NOP);
