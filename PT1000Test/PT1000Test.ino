...
void timerIsr(){
  ...
  koef = 1;  
*/
//float an =  (PI*timerCount%360)/180.0;
float an =  (2.0*0.01745329251994*(timerCount%360));
int rad = (int)5*sin(an);

  //Serial.print("T1,");
String str = "$" + String(timerCount) + (" ")+ String(rad + 70) + (" ")  + String(rad + 55) + ";" ;
